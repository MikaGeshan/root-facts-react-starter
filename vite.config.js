  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description: 'AI-powered vegetable identification and fun facts generator.',
        theme_color: '#10b981',
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            urlPattern: ({ url }) => url.origin === 'https://huggingface.co' || url.origin === 'https://cdn.jsdelivr.net',
            handler: 'CacheFirst',
            options: {
